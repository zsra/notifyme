...
- [ ] [Phase 01 - Foundational design docs & ADRs](phase-01-foundational-design-docs.md)
- [ ] [Phase 02 - Solution & project scaffolding](phase-02-solution-scaffolding.md)
...
Phase 00 in progress (this scaffolding). No application code exists yet; nothing beyond `ai/` and
`docs/` content has been created in the repo so far.
